        ...
        {/* Section de bienvenida */}
            ...
            style={{ backgroundImage: `url(${portada})` }}>
                <div className=" flex flex-col justify-center items-center h-full gap-6">
                    <h1 className="text-8xl font-bolt">Bienvenidos a <span className="text-emerald-950 font-extrabold">Green Land </span> </h1>
                    <p className="text-2xl font-normal text-gray-900">Donde está tu terreno soñado, con Descuentos exclusivos y posesion inmediata</p>
