...
export default function PropiedadesCard(params) {
    ...
    return(
        <>
            <div className="group w-80 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-emerald-200">
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3 text-gray-700">
                            ...
                            <span className="font-medium">{params.ubicacion}</span>
                        </div>

                        <div className="flex items-center gap-3 text-gray-700">
                            <div className="flex items-center gap-2 text-emerald-600 font-semibold min-w-fit">
                                <BsSuperscript className="w-5 h-5" />
                                <span>Superficie:</span>
                            </div>
                            <span className="font-medium">{params.superficie}</span>
                        </div>
                    </div>
