                    ...
                    <div className="w-80 border-gray-300 border-2 md:rounded-2xl md:rounded-b-md shadow-lg hover:shadow-xl transition-shadow duration-300">
                        ...
                        <div className="flex flex-col gap-4 p-4 bg-white">
                            ...
                            <div className="w-full flex justify-center items-center">
                                <h2 className="md:text-2xl font-bold text-center font-display">
                                    {params.titulo}
                                </h2>
                            </div>
                            {/* Informacion sobre lote (Ubicacion y disponibilida) */}
                            <div className="flex flex-col gap-2">
                                <p className="font-body flex items-center gap-3 md:text-xl text-gray-800">
                        ...
                        <Link to="/contacto" className="w-full">
                            <button className="font-body w-full bg-green-400 text-xl md:rounded-b-md p-1.5 hover:bg-green-200">Ver Contacto</button>
                        </Link>
                    </div>
                </>
    )
